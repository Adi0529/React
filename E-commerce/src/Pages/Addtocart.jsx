            ...
            <div className="container vh-100 d-flex flex-column justify-content-center align-items-center">
                ...
                <div className="text-center p-5 shadow rounded-4 bg-white border-top border-5 border-primary">
                    ...
                    <p className="text-muted">
                        Looks like you removed your items.
                    </p>

                    <button
                        className="btn btn-primary rounded-pill px-5 py-2 shadow-sm mt-3"
                        onClick={() => navigate('/')}
                    >
                        Return to Shop
                    </button>
                ...
                <div className="row g-4">
                                        ...
                                        <div className="row align-items-center">
                                            ...
                                            <div className="col-6 col-md-2 mt-3 mt-md-0">
                                                ...
                                                <div className="d-flex align-items-center justify-content-between border rounded-pill p-1 bg-light">
                                                    ...
                                                    <button
                                                        className="btn btn-sm btn-white shadow-sm rounded-circle fw-bold"
                                                        onClick={() =>
                                                            dispatch({
                    ...
                    <div className="col-lg-4">
                        ...
                        <div className="card border-0 shadow-lg rounded-4 bg-white p-4">
                            ...
                            <Link
                                to={state.login ? "/cart" : "/register"}
                                className={`${state.login ? "d-none" : ""} btn btn-primary w-100 py-3 rounded-3 fw-bold shadow`}
                            >
                                SECURE CHECKOUT
                            </Link>
                            <button onClick={() => alert("Order placed successfully!")} className={`${state.login ? "" : "d-none"} btn btn-primary w-100 py-3 rounded-3 fw-bold shadow`}>
                                Confirm order
                            </button>
